				...
				if ( m_bShowSelectedItemUnFocus )
				{
					...
					// Draw the focus of the beginning of each line of text out
						...
						for (int i = 0; i <nColumns; i++)
						{
							...
							rect.DeflateRect(6, 0); // shrink our rect x pixels in each direction : Pour corriger l'alignment du texte à gauche MaxMax14
					...
					//On  remet les anciens paramètres	// put back the old objects
...
{
	m_clrDefBack = GetTextBkColor();	// Retrieves background color of text labels in the control.
	m_clrDefText = GetTextColor();		// Retrieves foreground color of text labels in the control.
...
//-------------------------------------------------------------
void CListCtrlEx::SetDisplayEditorFlag (BOOL bEtat)	//Add by MaxMax14 le 06/05/12: mise à true/false de m_bDisplayEditorCalled
{
	m_bDisplayEditorCalled = bEtat;
}

//-------------------------------------------------------------
BOOL CListCtrlEx::GetDisplayEditorFlag ()	//Add by MaxMax14 le 06/05/12: Renvoi état (true/false) de m_bDisplayEditorCalled
{
...
//-------------------------------------------------------------
void CListCtrlEx::SetPenStyle (int iStyle)	//Définie type de trait //ex: PS_SOLID PS_DASH PS_DOT //Add by MaxMax14 le 05/10/13
{
	m_iPenStyles = iStyle;
}
...
//-------------------------------------------------------------
void CListCtrlEx::SetBordureActive (BOOL bBordure)	//Définie si on dessine la bordure //Add by MaxMax14 le 05/10/13
{
	m_bBordure = bBordure;
}
